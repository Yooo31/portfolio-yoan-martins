...
export default function ThemeMode() {
  ...
  return (
    <label className="swap swap-rotate">
      ...
      {theme === 'dark' ? (
        <svg className="swap-on fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28">
        ...
        <svg className="swap-off fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="28">
