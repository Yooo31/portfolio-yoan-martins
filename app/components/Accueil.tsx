      ...
      <div className="hero-content flex-col lg:flex-row-reverse">
        <div className="flex-col">
          <Image
            ...
            height={200}
          />
          <p className="text-center py-6 text-sm md:text-base mr-0 underline underline-offset-4 transition-transform hover:scale-105">
        ...
        <div className="flex flex-col">
          <div className="flex justify-start">
            <div>
              <h2
                id="typing"
                className="text-2xl md:text-5xl font-bold overflow-hidden whitespace-nowrap relative"
              >
                Hello World !!!
              </h2>
            </div>
